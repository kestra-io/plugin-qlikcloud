    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.qlikcloud.QlikcloudTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class QlikcloudTask extends Task implements RunnableTask<QlikcloudTask.Output> {
    @Schema(
    ...
    @Override
    public QlikcloudTask.Output run(RunContext runContext) throws Exception {
