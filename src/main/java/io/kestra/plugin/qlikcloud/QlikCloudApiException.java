 ...
 * (e.g. {@code RELOADS-007}) so callers can react to specific cases — a 404 on the trigger POST,
...
public class QlikCloudApiException extends IOException {
    ...
    /** Qlik's own {@code errors[].code} (e.g. {@code RELOADS-007}), or null when absent/unparsable. */
